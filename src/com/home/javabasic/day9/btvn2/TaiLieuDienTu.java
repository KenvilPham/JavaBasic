...
public class TaiLieuDienTu extends Sach implements ISach.IDownload {
    ...
    public TaiLieuDienTu(String mMaSach, String mTenSach, String mNhaXuatBan, int mNamXuatBan, long mSoLuongSach, float mDungLuong, long mLuotTai, long mGiaThanh) {
